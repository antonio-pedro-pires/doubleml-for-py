...
def _fit_nuisance_potential_manual(
    ...
    if is_classifier(learner_px):
        px_hat_list = fit_predict_proba(d, x, ml_px, px_params, smpls, trimming_threshold=trimming_threshold)
    else:
...
def _fit_nuisance_counterfactual_manual(
    ...
    if is_classifier(ml_pmx):
        pmx_hat_list = fit_predict_proba(y, x, ml_pmx, pmx_params, smpls, trimming_threshold=trimming_threshold)
    else:
        pmx_hat_list = fit_predict(y, x, ml_pmx, pmx_params, smpls, trimming_threshold=trimming_threshold)
